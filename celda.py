class Celda: #clase celda, parte de la version de dani modificandola
    ...
    def borrar_letra(self):             #borra y devuelve la letra borrada
    ...
    def calcular_puntos(self,): # los puntos representan la cantidad total de puntos sumados por las letras de la palabra hasta el momento y el mult la cantidad de veces que los puntos totales de la palabra se multiplican
        if self.get_modificador()[0] == "+":    # operador de suma
            puntos = self.get_modificador()[1] + self.valor_base()
