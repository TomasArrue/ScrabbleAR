...
def iniciar_juego():
    ...
    diccionario_funciones[0] = cargar_letra_1(window,letras_usadas_en_tablero,
                                                botones_usados,
                                                letras_atril_jugador,
                                                lugares_no_disponibles,letra,
                                                event,lugar,puntos_jugador)

    diccionario_funciones[1] = cargar_letra_2(window,letras_usadas_en_tablero,
                                                botones_usados,
                                                letras_atril_jugador,
                                                lugares_no_disponibles,letra,
                                                event,lugar,puntos_jugador)

    diccionario_funciones[2] = cargar_letra_3(window,letras_usadas_en_tablero,
                                                botones_usados,
                                                letras_atril_jugador,
                                                lugares_no_disponibles,letra,
                                                event,lugar,puntos_jugador)
