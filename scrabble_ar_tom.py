        ...
        if event in (None, 'Salir'):
            ...
            # para inicializar el juego
                ...
                if os.path.isfile('./texto/save.json'):
                    counter, dificult, puntos_jugador, puntos_jugador_total, puntos_npc, puntos_npc_total, h, v, fin_tiempo= funciones.cargar_partida(
                        window, letras_atril_jugador, botones_usados, lugares_no_disponibles, l2_guar, letras_atril_riva)
...
################################################################################
# liena 314 compara con un numero constante. hay que cambiar
# por la variable de tiempo
# linea 74: fin_tiempo = 60000 # 10 min
# ejemplo:
# si la var dice 4 min se multiplica 6000 por 4
#
# esto tambien implica una nueva variable
# para guardar, cargar y save.json:
#
# -save_tom.json: linea 97 "fin": 60000 representa
#  que esta partida termina a los 10 min
#
# -guardar linea 392 dic['tiempo'] = {'fin': fin_tiempo}
#
# -cargara linea 242 agregar fin_tiempo como variable que va a devolver el return
